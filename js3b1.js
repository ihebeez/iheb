...
f=1;
const hideBtna1 = document.getElementById('exit-btn');
const showBtna1 = document.getElementById('login-btn');
const elementa1 = document.getElementById('options');

if(f==1){
    elementa1.classList.add('hidden');  
    hideBtna1.classList.add('hidden'); 
}
hideBtna1.addEventListener('click', function() {
  console.log('Hide button clicked');
  elementa1.classList.add('hidden');
...
showBtna1.addEventListener('click', function() {
    f--;
  console.log('Show button clicked');
  elementa1.classList.remove('hidden');
  showBtna1.classList.add('hidden');
  hideBtna1.classList.remove('hidden'); 

});

z=1;

const hideBtn1 = document.getElementById('exit-btn');
const showBtn1= document.getElementById('disconnect');
const showBtn7 = document.getElementById('img-profil');
const showBtn8 = document.getElementById('name-client');

const element7 = document.getElementById('option');

const appointment = document.getElementById('appointment');
if(z==1){
    element7.classList.add('hidden');  
    hideBtn1.classList.add('hidden'); 
}
hideBtn1.addEventListener('click', function() {
  console.log('Hide button clicked');
  element7.classList.add('hidden');
  showBtn7.classList.remove('hidden');
  showBtn8.classList.remove('hidden');
  hideBtn1.classList.add('hidden'); 
...
showBtn1.addEventListener('click', function() {
  ...
  showBtn7.classList.add('hidden');
  showBtn8.classList.add('hidden');
  hideBtn1.classList.remove('hidden'); 
