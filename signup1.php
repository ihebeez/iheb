...
$req = "INSERT INTO voyageur values(null,'$name','$sename','$gender',$phone,'$cin','$email',$date,'$psw')";
$req1 = "SELECT cin, email FROM patient";
$con = mysqli_connect("localhost","root","","PROJET1");
$resultat = mysqli_query($con,$req1);

while($ligne = mysqli_fetch_array($resultat)){
    
    if($ligne[0] == $cin or $ligne[1] == $email) {
        header("Location: sign-up1.html");
        break;
    }
